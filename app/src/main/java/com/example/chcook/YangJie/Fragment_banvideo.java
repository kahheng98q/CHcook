...
import com.example.chcook.KahHeng.EndUser.DA.recyclerViewAdapter_banVideo;
...
//                    SimpleDateFormat tt = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
//                    Long formatedDate = Long.valueOf(upDate);
//                    String ddate = tt.format(upDate);
...
//                        public Report(String date, String reason, String username, String videoId, String videoName) {
                        reportedVideoArraylist.add(new Report(dd,Reason,Reporter,videoId,videoName));
