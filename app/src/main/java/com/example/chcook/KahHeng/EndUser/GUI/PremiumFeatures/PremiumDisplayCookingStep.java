 ...
 */
public class PremiumDisplayCookingStep extends Fragment implements RecognitionListener {
    private View view = null;
    private ImageView imageView = null;
    private TextView stepDesc = null;
    private TextView txtstepPosition = null;
    private TextView txtRecipeTitle = null;
    ...
    public PremiumDisplayCookingStep() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_premium_display_cooking_step, container, false);
...
//        btnActivate=view.findViewById(R.id.btnActiveVoice);
        ...
        txtstepPosition = view.findViewById(R.id.txtStep);
        txtRecipeTitle = view.findViewById(R.id.txtRecipeTitle);
//        returnedError = findViewById(R.id.errorView1);
        ...
        if (bundle != null) {
            ...
            txtRecipeTitle.setText(recipeTitle);
            ...
            cookingStepDA.getUploadedCooking(new CookingStepDA.StepsCallback() {
                ...
                public ArrayList<CookingSteps> onCallback(ArrayList<CookingSteps> cookingSteps) {
                    ...
                    if (!tmpCookingSteps.isEmpty()) {
                        ...
                        txtstepPosition.setText("Step" + 1);
                    } else {
                        imageView.setVisibility(View.GONE);
                        stepDesc.setText("The Recipe is Incomplete");
